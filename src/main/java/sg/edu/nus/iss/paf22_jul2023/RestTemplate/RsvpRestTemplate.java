package sg.edu.nus.iss.paf22_jul2023.RestTemplate;
...
public class RsvpRestTemplate {
    ...
    public List<RSVP> getRSVPS() {
        ...
        ResponseEntity<List<RSVP>> results = restTemplate.exchange(RSVP_ENDPOINT_URL, HttpMethod.GET, entity,
    ...
    public Boolean updateRSVP(RSVP rsvp) {
        ...
        ResponseEntity<Boolean> result = restTemplate.exchange(RSVP_ENDPOINT_URL, HttpMethod.PUT, entity,
                Boolean.class);
